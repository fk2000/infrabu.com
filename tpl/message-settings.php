<?php _e("I hope you're enjoying Pitch. ", 'siteorigin') ?>
<?php _e("<a href='mailto:support@siteorigin.com'>Email me</a> if you've read the documentation and still need help. ", 'siteorigin') ?>
<?php _e("Follow me for updates ", 'siteorigin') ?>
